#!/usr/bin/env python3
"""ATL-6C support bundle validator (Python stdlib only).

Verifies the ATL-6C support bundle is ready to ship to Castform support / Castie:
  * support directory exists
  * ATL6C_SUPPORT_REQUEST.md exists
  * ATL6C_FAILURE_SUMMARY.md exists
  * both run_ids (c83f971d... and 56cb5701...) are referenced in both files
  * FAILED_STEP_0_NO_ROLLOUTS_REPEATED is referenced in both files
...
REQUEST_FILE = SUPPORT_DIR / "ATL6C_SUPPORT_REQUEST.md"
SUMMARY_FILE = SUPPORT_DIR / "ATL6C_FAILURE_SUMMARY.md"

RUN_ID_RUN1 = "c83f971d-2b2c-42b8-9774-ca64938c1286"
RUN_ID_RUN2 = "56cb5701-6b3e-424e-b671-fc2efc932aa8"
STATUS_TAG = "FAILED_STEP_0_NO_ROLLOUTS_REPEATED"
...
def main() -> int:
    ...
    issues.extend(_check_file(REQUEST_FILE, [RUN_ID_RUN1, RUN_ID_RUN2, STATUS_TAG]))
    ...
    print(f"  - run_id Run 1 present in both: {RUN_ID_RUN1}")
    print(f"  - run_id Run 2 present in both: {RUN_ID_RUN2}")
